...
namespace DatabaseWcfService
{
    ...
    public interface IDatabaseWcfService
    {
        ...
        [OperationContract]
        List<EconomicFundamentals> GetEconomicFundamentals(List<string> symbolList, List<string> eventTypeList, DateTime startDate, DateTime endDate, string category, string country);
